...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_redirects_redirect_translation', (
            ...
            (
                ...
                (related_name='translations', null=True, to=orm['aldryn_redirects.Redirect'])),
        ))
        ...
        db.create_table(u'aldryn_redirects_redirect', (
            ...
            (
                'site',
                self.gf('django.db.models.fields.related.ForeignKey')
                (related_name='redirects_hvad_set', to=orm['sites.Site'])
            ),
    ...
    models = {
        u'aldryn_redirects.redirect': {
            'Meta':
                {'ordering': "('old_path',)", 'unique_together': "(('site', 'old_path'),)", 'object_name': 'Redirect'},
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [],
                     {'related_name': "'redirects_hvad_set'", 'to': u"orm['sites.Site']"})
        },
        u'aldryn_redirects.redirecttranslation': {
            'Meta':
                {'unique_together': "[('language_code', 'master')]",
                 'object_name': 'RedirectTranslation',
                 'db_table': "u'aldryn_redirects_redirect_translation'"
                 },
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': (
                'django.db.models.fields.related.ForeignKey', [],
                {'related_name': "'translations'", 'null': 'True', 'to': u"orm['aldryn_redirects.Redirect']"}),
